...
export class ChartDetailComponent implements OnInit {
  ...
  datosDetalle = [
    ...
    },
    {
      ...
      value: 9989,
      qtrBreakdown: [
        {name: "Ventas de temporada", id:'ventas', parent: null, value: 9989},
  ...
  pintarGraficaBarra() {
    ...
    this.datosDetalle.forEach((element) => {
      if (element['x'] == this.id) {
        this.detailsBarChart.column(element['qtrBreakdown']).name(element['name']);
      }
    });
  ...
  pintarGraficaSunburst() {
    ...
    this.detailsSunburstChart.container(this.chartDetailsContainer.nativeElement);
